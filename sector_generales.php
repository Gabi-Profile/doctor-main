...
<body>
    <div class="container">
        <?php if (count($insumos) > 0): ?>
            ...
            ?>
                <div class="insumo-card">
                    <form method="POST" action="carrito_insumos.php" style="display: flex; flex-direction: column; align-items: center;">
        ...
        <button type="submit" style="background-color:rgb(36, 98, 179); color: white; border: none; padding: 5px 10px; border-radius: 4px; cursor: pointer;">
            +
        </button>
    </form>
</div>
